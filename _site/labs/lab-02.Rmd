...
> Recommended Reading: [Chapter 4-5, Modern Data Science with R, 3rd edition. Baumer et al. 2024.](https://mdsr-book.github.io/mdsr3e/)

---

## Lab 02-A: Modifying Dataframes

Let's first import the datasets and necessary packages. After installing this package with `devtools::install_github('andykrause/kingCoData')`, you can load the data with: `data(kingco_sales)` and `data(kingco_homes)`. You can find the datasets and Readme file in [this repository](https://github.com/andykrause/kingCoData).
...
We are going to use the sale price data to understand the most important theorem in statistics, [Central Limit Theorem (CLT)](https://en.wikipedia.org/wiki/Central_limit_theorem). I **highly** recommend [this video from 3Blue1Brown](https://www.youtube.com/watch?v=zeJD6dqJ5lo&t=68s) to understand CLT. 
...
So far, we've learned a lots functions, please use as many as possible to explore topics you are interested in about the King County datasets. Please use at least 5 functions below and brief discuss your results. After finish this lab, you need to submit everything via Canvas assignment page.
