...
`ggplot2` is built on the **G**rammar of **G**raphics — a system that describes plots as combinations of independent components. This is a typical chunk of ggplot2.
...
![Simplified ggplot. Source: Luka Negoita](assets/ggplot2_simplified.png)
