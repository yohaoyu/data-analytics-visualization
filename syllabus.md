...
6. Understand the basic taxonomy of a time series and basic forecasting techniques
7. Interpret data visualizations, document, and present your data analysis using R Markdown

Overall students are expected to gain proficiency in identifying the appropriate visual method based on the dataset they have and the message they would like to convey.
...
- *Optional readings* are useful for the class topics and I encourage you read them bfore the class.
